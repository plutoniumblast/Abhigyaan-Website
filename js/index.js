...
function Imgs(photos){
    return `
    <div class="tm-gallery-img-container">
      <a href="./img/${photos.Serial}" class="tm-gallery-img-link">
      <img src="./img/${photos.Serial}" alt="Image" class="img-fluid tm-gallery-img">
      </a>
    </div>
    `
}
